...
function initializeMap(
    ...
    yolobusLegend.onAdd = function (map) {
        ...
        div.innerHTML +=
            '<i style="background: purple;"></i><span>West Sacramento Local</span><br>';
        div.innerHTML +=
            '<i style="background: orange;"></i><span>Woodland Local/Express</span><br>';
        div.innerHTML +=
            '<i style="background: green; width: 9px; margin: 0;"></i><i style="background: black; width: 9px;"></i><span>Intercity</span><br>';
        div.innerHTML +=
            '<i style="background: red;"></i><span>Davis Express</span><br>';
    ...
    unitransLegend.onAdd = function (map) {
        ...
        div.innerHTML +=
            '<i style="background: #4CC8F2;"></i><span>Memorial Union</span><br>';
        div.innerHTML +=
            '<i style="background: #2E3092;"></i><span>Silo</span><br>';
        div.innerHTML +=
            '<i style="background: #C276C4;"></i><span>Davis High & Junior High</span><br>';
        // Allow scrolling inside legend on mobile
        L.DomEvent.disableClickPropagation(div);
        L.DomEvent.disableScrollPropagation(div);
        return div;
        ...
        children: [
            {
                ...
                children: [
                    {
                        label: "Yolobus Service Area",
                        layer: borders.customGetLayer("yolobusServiceArea"),
                    },
                    {
                        label: "Yolo County Border",
                        layer: borders.customGetLayer("yoloCountyBoundary"),
                    },
                ],
            },
            {
                        ...
                        children: [
                            {
                                ...
                                children: [
                                    {
                                        label: "37",
                                        layer: getRouteLayer(yolobus, "37"),
                                    },
                                    {
                                        label: "40",
                                        layer: getRouteLayer(yolobus, "40"),
                                    },
                                    {
                                        label: "41",
                                        layer: getRouteLayer(yolobus, "41"),
                                    },
                                    {
                                        label: "240",
                                        layer: getRouteLayer(yolobus, "240"),
                                    },
                                ],
                            },
                            {
                                ...
                                children: [
                                    {
                                        label: "211",
                                        layer: getRouteLayer(yolobus, "211"),
                                    },
                                    {
                                        label: "212",
                                        layer: getRouteLayer(yolobus, "212"),
                                    },
                                ],
                            },
                            {
                                ...
                                children: [
                                    {
                                        label: "42A",
                                        layer: getRouteLayer(yolobus, "42A"),
                                    },
                                    {
                                        label: "42B",
                                        layer: getRouteLayer(yolobus, "42B"),
                                    },
                                    {
                                        label: "138",
                                        layer: getRouteLayer(yolobus, "138"),
                                    },
                                    {
                                        label: "215",
                                        layer: getRouteLayer(yolobus, "215"),
                                    },
                                ],
                            },
                            {
                                ...
                                children: [
                                    {
                                        label: "43",
                                        layer: getRouteLayer(yolobus, "43"),
                                    },
                                    {
                                        label: "43R",
                                        layer: getRouteLayer(yolobus, "43R"),
                                    },
                                    {
                                        label: "44",
                                        layer: getRouteLayer(yolobus, "44"),
                                    },
                                    {
                                        label: "230",
                                        layer: getRouteLayer(yolobus, "230"),
                                    },
                                ],
                            },
                            {
                                ...
                                children: [
                                    {
                                        label: "45",
                                        layer: getRouteLayer(yolobus, "45"),
                                    },
                                ],
                            },
                        ],
                        ...
                        children: [
                            {
                                ...
                                children: [
                                    {
                                        label: "A",
                                        layer: getRouteLayer(unitrans, "A"),
                                    },
                                    {
                                        label: "B",
                                        layer: getRouteLayer(unitrans, "B"),
                                    },
                                    {
                                        label: "E",
                                        layer: getRouteLayer(unitrans, "E"),
                                    },
                                    {
                                        label: "F",
                                        layer: getRouteLayer(unitrans, "F"),
                                    },
                                    {
                                        label: "G",
                                        layer: getRouteLayer(unitrans, "G"),
                                    },
                                    {
                                        label: "K",
                                        layer: getRouteLayer(unitrans, "K"),
                                    },
                                    {
                                        label: "M",
                                        layer: getRouteLayer(unitrans, "M"),
                                    },
                                    {
                                        label: "O",
                                        layer: getRouteLayer(unitrans, "O"),
                                    },
                                    {
                                        label: "P",
                                        layer: getRouteLayer(unitrans, "P"),
                                    },
                                    {
                                        label: "Q",
                                        layer: getRouteLayer(unitrans, "Q"),
                                    },
                                    {
                                        label: "U",
                                        layer: getRouteLayer(unitrans, "U"),
                                    },
                                    {
                                        label: "FMS",
                                        layer: getRouteLayer(unitrans, "FMS"),
                                    },
                                ],
                            },
                            {
                                ...
                                children: [
                                    {
                                        label: "C",
                                        layer: getRouteLayer(unitrans, "C"),
                                    },
                                    {
                                        label: "D",
                                        layer: getRouteLayer(unitrans, "D"),
                                    },
                                    {
                                        label: "J",
                                        layer: getRouteLayer(unitrans, "J"),
                                    },
                                    {
                                        label: "L",
                                        layer: getRouteLayer(unitrans, "L"),
                                    },
                                    {
                                        label: "V",
                                        layer: getRouteLayer(unitrans, "V"),
                                    },
                                    {
                                        label: "VL",
                                        layer: getRouteLayer(unitrans, "VL"),
                                    },
                                    {
                                        label: "VX",
                                        layer: getRouteLayer(unitrans, "VX"),
                                    },
                                    {
                                        label: "W",
                                        layer: getRouteLayer(unitrans, "W"),
                                    },
                                    {
                                        label: "Z",
                                        layer: getRouteLayer(unitrans, "Z"),
                                    },
                                ],
                            },
                            {
                                ...
                                children: [
                                    {
                                        label: "T",
                                        layer: getRouteLayer(unitrans, "T"),
                                    },
                                ],
                            },
                        ],
                        ...
                        children: [
                            {
                                ...
                                layer: yoloPOIs.customGetLayer(
                                    "yoloArts_Entertainment",
                                ),
                            },
                            {
                                label: "Education",
                                layer: yoloPOIs.customGetLayer("yoloEducation"),
                            },
                            {
                                label: "Employment",
                                layer: yoloPOIs.customGetLayer(
                            ...
                            {
                                label: "Retail",
                                layer: yoloPOIs.customGetLayer("yoloRetail"),
                            },
                            {
                                label: "Tourism",
                                layer: yoloPOIs.customGetLayer("yoloTourism"),
                            },
                            {
                                label: "Travel",
                                layer: yoloPOIs.customGetLayer("yoloTravel"),
                            },
                        ],
                    },
                    {
                        ...
                        children: [
                            {
                                label: "Arts & Entertainment",
                                layer: sacPOIs.customGetLayer(
                                    "sacArts_Entertainment",
                                ),
                            },
                            {
                                label: "Education",
                                layer: sacPOIs.customGetLayer("sacEducation"),
                            },
                            {
                                label: "Employment",
                                layer: sacPOIs.customGetLayer("sacEmployment"),
                            },
                            {
                                label: "Healthcare",
                                layer: sacPOIs.customGetLayer("sacHealthcare"),
                            },
                            {
                                label: "Public & Social Services",
                                layer: sacPOIs.customGetLayer(
                                    "sacPublic_Social_Services",
                                ),
                            },
                            {
                                label: "Residential",
                                layer: sacPOIs.customGetLayer("sacResidential"),
                            },
                            {
                                label: "Retail",
                                layer: sacPOIs.customGetLayer("sacRetail"),
                            },
                            {
                                label: "Tourism",
                                layer: sacPOIs.customGetLayer("sacTourism"),
                            },
                            {
                                label: "Travel",
                                layer: sacPOIs.customGetLayer("sacTravel"),
                            },
                        ],
                    },
                ],
...
async function createGeoJson(
    ...
    try {
        ...
        if (typeof file === "string") {
            ...
            if (!response.ok) {
                console.error(
                    `Error loading GeoJSON file: ${file}, Status: ${response.status}`,
                );
        ...
        if (
            fileName !== "CalEnviroScreen" &&
            fileName !== "Yolobus Service Area"
        ) {
            ...
            const firstCoord = firstFeature?.geometry
                ? getFirstCoord(firstFeature.geometry)
                : null;

            if (firstCoord && looksLike3857(firstCoord)) {
                console.log(
                    `Reprojecting ${fileName} from EPSG:3857 → EPSG:4326`,
                );
        ...
        layerGroup = L.geoJson(data, {
            ...
            pointToLayer: function (feature, latlng) {
                ...
                if (fileName.includes("Stops")) {
                    const stopName =
                        feature.properties.stop_name || feature.properties.name;
                    const popupContent =
                        stopName && agencyName
                            ? `<strong>${agencyName}: ${stopName}</strong>`
                            : agencyName
                              ? `<strong>${agencyName} Stop</strong>`
                ...
                if (fileName.split(" ")[1] === "Arts_Entertainment") {
                    ...
                    fileName.split(" ")[1] === "Public_Social_Services"
                ) {
            ...
            style: function (feature) {
                ...
                else if (category && category in categoryColors)
                    color = categoryColors[category];

                for (const [routeType, routeIds] of Object.entries(
                    routeTypes,
                )) {
                ...
                if (fileName == "CalEnviroScreen") {
                    ...
                    color =
                        feature.properties.CIscoreP > 90
                            ? "#F06F5C"
                            : feature.properties.CIscoreP > 80
                              ? "#F29262"
                              : feature.properties.CIscoreP > 70
                                ? "#F4B169"
                                : feature.properties.CIscoreP > 60
                                  ? "#F8CD71"
                                  : feature.properties.CIscoreP > 50
                                    ? "#FDF07B"
                                    : feature.properties.CIscoreP > 40
                                      ? "#E9F079"
                                      : feature.properties.CIscoreP > 30
                                        ? "#BFD26E"
                                        : feature.properties.CIscoreP > 20
                                          ? "#99B863"
                                          : feature.properties.CIscoreP > 10
                                            ? "#7B9F5A"
                                            : "#5E8751";
                    opacity = 0.9;
                    fillOpacity = 0.6;
...
async function gtfsZipToGeoJSON(gtfsFile) {
    ...
    if (typeof gtfsFile === "string") {
        ...
        if (!response.ok)
            throw new Error(`Failed to fetch GTFS zip: ${gtfsFile}`);
    ...
    routes.forEach((route) => {
        ...
        const features = shapeIds.map((shapeId) => {
            const points = shapes
                ...
                .sort(
                    (a, b) =>
                        parseFloat(a.shape_pt_sequence) -
                        parseFloat(b.shape_pt_sequence),
                )
                .map((s) => [
        ...
        routesGeoJSONs.set(route.route_id, {
            type: "FeatureCollection",
            features,
        });
    });
...
async function addTransitData(gtfsFile, agencyName, busStopMarker) {
    const { stopsGeoJSON: stops, routesGeoJSONs: routes } =
        await gtfsZipToGeoJSON(gtfsFile);

    var stopsLayer = await createGeoJson(
        stops,
        `${agencyName} Stops`,
        busStopMarker,
        agencyName,
...
function setupEventListeners() {
    ...
    document
        .getElementById("isoline-type")
        .addEventListener("change", updateValueUnit);

    // Dialog overlay click to close
    document
        .getElementById("isoline-dialog")
...
async function handleFormSubmit(event) {
    ...
    try {
        // Fetch isoline data
        const isolineData = await fetchIsoline(
            coordinates,
            travelMode,
            isolineType,
            isolineValue,
        ...
        alert(
            "Error fetching isoline data. Please check your API key and try again.",
        );
...
function removeMarker(markerId) {
    const markerIndex = markers.findIndex(
        (marker) => marker._markerId === markerId,
    );
    if (markerIndex !== -1) {
...
function listActiveLayers(layer) {
    ...
    for (activePOI of activePOIs) {
        for (feature of Object.values(activePOI._layers)) {
            ...
            name.innerHTML = feature.feature.properties.name
                ? feature.feature.properties.name
                : "-";
            const city = document.createElement("td");
            city.innerHTML =
                feature.feature.properties?.["addr:street"] &&
                feature.feature.properties?.["addr:city"]
